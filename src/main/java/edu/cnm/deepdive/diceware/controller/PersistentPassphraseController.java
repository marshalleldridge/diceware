...
public class PersistentPassphraseController {
  ...
  @Autowired
  public PersistentPassphraseController(PassphraseGenerator generator,
  ...
  public Passphrase post(@RequestBody Passphrase passphrase) {
    ...
    passphrase.getWords().clear(); //FIXME Respect words provided by client.
  ...
  public Iterable<Passphrase> get() {
    return repository.getAllByOrderByCreatedAsc();
  }
}
